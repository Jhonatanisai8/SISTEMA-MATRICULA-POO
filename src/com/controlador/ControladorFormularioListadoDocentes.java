...
public class ControladorFormularioListadoDocentes
    ...
    public ControladorFormularioListadoDocentes(frmListadoDocentesView lfrmistadoDocentesView, frmMenuView frmMenuView) {
        ...
        this.frmDocentesView.btnEliminar.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //click en el evento de eliminar
        if (e.getSource() == this.frmDocentesView.btnEliminar) {
            ProcesosFormularioListadoDocentes.seleccionarDatosEliminar(this.frmDocentesView);
